<div x-data="{ modalOpen: false }" @keydown.escape.window="modalOpen = false" class="relative z-50 w-auto h-auto">
    <button @click="modalOpen=true"
        class="inline-flex items-center justify-center h-10 px-4 py-2 text-sm font-medium transition-colors bg-blue-500 border rounded-md hover:bg-neutral-100 active:bg-white focus:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-neutral-200/60 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none">message from the team</button>
            ...
            <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                ...
                <div class="relative w-auto">
                    ...
                    document.addEventListener('fullscreenchange', (e) => {
                        ...
                        @mouseleave="mouseleave=true" @mousemove="mousemoveVideo"
                        class="relative h-[360px] min-w-[640px] overflow-hidden rounded-md aspect-video">
                        <video x-ref="player" @loadedmetadata="metaDataLoaded" @timeupdate="timeUpdatedInterval"
                            @ended="videoEnded" preload="metadata" :poster="poster"
                            class="relative z-10 object-cover w-full h-full bg-black" crossorigin="anonymous">
                        ...
                        <div x-show="videoPlayerReady" class="absolute inset-0 w-full h-full">
                            <div x-ref="videoBackground" @click="togglePlay()"
                                ...
                                <div class="absolute z-10 duration-300 ease-out group-hover:scale-110">
                                    <button x-show="!playing"
                                        ...
                                        type="button">
                                        <svg class="w-5 h-5 translate-x-px" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M8.42737 3.41611C6.46665 2.24586 4.00008 3.67188 4.00007 5.9427L4 18.0572C3.99999 20.329 6.46837 21.7549 8.42907 20.5828L18.5698 14.5207C20.4775 13.3802 20.4766 10.6076 18.568 9.46853L8.42737 3.41611Z"
                            ...
                            <div x-show="controls" @click="resetControlsTimeout"
                                ...
                                <div class="absolute right-0 top-0 mr-0.5 mt-0.5 flex items-center">
                                    <div class="flex items-center h-auto group">
                                        ...
                                        <div
                                            class="relative h-1.5 w-0 mx-0 group-hover:mx-1 rounded-full group-hover:w-12 invisible group-hover:visible w-0 ease-out duration-300">
                                            <input x-ref="volume" @input="updateVolume(event)" type="range"
                            ...
                            <div x-show="controls" @click="resetControlsTimeout"
                                ...
                                <div class="absolute bottom-0 z-30 w-full px-2.5 -translate-y-8">
                                    <div class="relative w-full h-1 rounded-full">
                                        <input x-ref="videoProgress" @click="timelineClicked"
                                            @input="timelineSeek(event)" type="range" min="0"
                                            max="100" value="0" step="any"
                                            class="w-full h-full appearance-none flex items-center cursor-pointer bg-transparent z-30
